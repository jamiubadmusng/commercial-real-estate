...
| Best Regression R² | 98.75% (Random Forest) |
| Regression MAPE | 2.5% |
...
│
├── data/
│   ├── raw/                          # Original datasets (download separately)
│   │   ├── opa_properties_public.csv # ~291 MB - auto-downloaded by notebook
│   │   └── assessments.csv           # ~438 MB - auto-downloaded by notebook
│   └── processed/                    # Generated by running notebook
│       └── commercial_properties_processed.csv  # ~173 MB
│
├── docs/
...
│       ├── building_characteristics.png
│       ├── correlation_matrix.png
│       ├── market_trends.png
│       ├── trends_by_type.png
│       ├── covid_impact.png
│       ├── decline_rate_by_type.png
...
│   ├── value_decline_classifier.joblib
│   ├── property_value_regressor.joblib
│   ├── scaler_classification.joblib
│   └── scaler_regression.joblib
│
├── notebooks/
│   └── commercial_property_analysis.ipynb  # Main analysis notebook
│
└── src/
    └── predict_value.py              # Standalone prediction module
```
